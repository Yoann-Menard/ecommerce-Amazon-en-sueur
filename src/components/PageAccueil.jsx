        ...
        <main>
          ...
          <div className='main-padding-top'>
            <div className='container container-background bg-ecommerce1'>
              <div>
                <h2 className='main-tendance'>
                  Les réalisations les plus demandés
                </h2>
          ...
          <div className='main-padding-top-devis'>
            <div className='container main-devis'>
              <div>
                <div>
                  <h1 className='main-devis-h1'>
                    Obtenez des pièces de qualité rapidement et sans difficulté
                  </h1>
                  ...
                  <div className='main-devis-logo'>
                    ...
                    <Link
                      ...
                      to='#'
                    >
                      Suivre la production de vos pièces
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className='main-temoignage-para container-background'>
                  <div className='temoignage-padding'>
                    ...
                    <p>
                      ...
                      Laborum aliquam necessitatibus provident quibusdam aliquid
                      beatae, cupiditate reiciendis doloribus voluptatem dolores
                      ipsam corrupti, quia sit eveniet numquam, corporisLorem
                      ipsum dolor sit amet consectetur adipisicing elit. Laborum
                      aliquam necessitatibus provident quibusdam aliquid beatae,
                      cupiditate reiciendis doloribus voluptatem dolores ipsam
                      corrupti, eos aut dolorum.
                    </p>
                  </div>
                </div>
          ...
          <div className='main-padding-top main-confiance-top'>
            <div className='container main-confiance container-background'>
              ...
              <div className=''>
                ...
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>protection de données
                </p>
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>Service supplémentaire: marquage
                  de pièce, personnalisation
                </p>
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>Vérification de la production
                </p>
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>Certification des matériaux
                </p>
              </div>
            </div>
          </div>
          <div className='main-padding-top main-confiance-top'>
            <div className='container main-confiance container-background'>
              <div className='main-rencontre-p'>
                ...
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>Pour toutes les générations
                </p>
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>Créez-toi un réseau d'ami
                </p>
                <p className='confiance-p'>
                  <i class='fas fa-check'></i>Partage nous tes impressions 3D
                </p>
              </div>
